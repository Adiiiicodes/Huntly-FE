  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.user) {
        // For signup, we might need to handle differently since there's no token in SignupResponse
        // You might want to auto-login after signup or redirect to login page
        toast({
          variant: "default",
          title: "Sign Up Successful!",
          description: "Welcome to HuntLy! Please log in to continue.",
        });
        router.push('/login');
      } else {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Join HuntLy and start your hiring journey
            </p>
          </div>
